...
impl<B: BroadcastTypeTrait> WebSocketConfig<B> {
    ...
    /// # Returns
    ///
    /// - `&ArcFnPinBoxSendSync` - A reference to the request hook.
    ...
    /// # Returns
    ///
    /// - `&ArcFnPinBoxSendSync` - A reference to the sended hook.
    ...
    /// # Returns
    ///
    /// - `&ArcFnPinBoxSendSync` - A reference to the closed hook.
